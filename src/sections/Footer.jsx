...
const Footer = ({ height = '600px' }) => {
  ...
  return (
    <footer
      className="w-full bg-[#111111] text-white flex flex-col justify-between pt-16 pb-12 md:pt-24 md:pb-16 px-8 md:px-16 lg:px-24 font-sans relative overflow-hidden"
      style={{ height }}
    >
      <div className="flex flex-col lg:flex-row justify-between items-start gap-16 lg:gap-8 z-10">
        <div className="lg:w-1/2">
          <h2 className="font-display max-w-7xl text-[24px] lg:text-[44px] text-white leading-[1.1] font-normal tracking-tight">
            Smarter Restaurant Management<br className="hidden md:block" /> Starts with RestroHub.
          </h2>
          <p className="max-w-xl pt-4 text-[14px] opacity-60 text-white">
            Automate operations, delight guests, and grow faster.<br />
            The all-in-one platform designed for modern restaurants.
          </p>
        </div>
      ...
      <div className="pt-8 flex flex-col md:flex-row justify-between items-start md:items-end gap-12 z-10">
        <div className="flex items-center gap-6">
          <img src="/restro2.png" alt="RestroHub Logo" className="h-15 w-auto object-contain" />
        </div>

        <div className="flex flex-col items-start gap-2.5 text-[12px] text-[#888888] font-medium tracking-wide">
          <div className="flex flex-wrap items-center gap-6">
            <p>© 2026 RestroHub. All rights reserved.</p>
