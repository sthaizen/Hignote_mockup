...
const HeroComp = () => {
  ...
  return (
    <section ref={containerRef} className="relative w-full min-h-screen pt-[12vh] flex flex-col items-center font-['Inter',sans-serif] z-10 overflow-hidden">
      ...
      <div className="flex flex-col items-center text-center px-4 max-w-5xl mx-auto mb-16">
        <p className="text-xs font-mono text-gray-400 tracking-wider mb-6 flex items-center gap-2">
          RestroHub makes ordering simple <ArrowRight size={14} />
        </p>
        
        <h1 className="text-[3.5rem] md:text-[5.5rem] leading-[1.05] font-semibold text-[#111111] tracking-tight mb-6">
        ...
        <button className="bg-[#0f0f0f] text-white px-6 py-3.5 rounded-lg flex items-center gap-3 hover:bg-black hover:scale-105 transition-all duration-300 shadow-lg font-medium text-[15px]">
          Start your free trial <ArrowRight size={18} />
        </button>
      </div>

      {/* Phone and Floating Cards Section */}
      <div className="relative w-full max-w-[320px] md:max-w-[380px] mx-auto mt-8 flex-grow flex items-end">
        {/* The Phone Mockup */}
        <img 
          src="/Phone.png" 
